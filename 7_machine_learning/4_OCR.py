...
result: 目前只有 knearest 可以用
$ python 4_OCR.py --model knearest
loading data ../assets4/letter-recognition.data ...
training KNearest ...
testing...
train rate: 94.960000  test rate: 92.010000


ref: https://fossies.org/diffs/opencv/3.0.0_vs_3.1.0/samples/python2/letter_recog.py-diff.html
'''
...
if __name__ == '__main__':
    ...
    args.setdefault('--data', '../assets4/letter-recognition.data')
